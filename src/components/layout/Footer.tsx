        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground mb-4">
              Luxury fashion and bespoke tailoring for the modern Nigerian.
              Elevating style since 2022.
            </p>
            <div className="flex space-x-4">
              <Link
                href={"https://www.tiktok.com/@tocianoboutique"}
                target="_blank"
              >
              ...
              <Link
                href={"https://www.instagram.com/tociano.boutique/"}
                target="_blank"
              >
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Tociano Boutique. All rights
              reserved.
            </p>
